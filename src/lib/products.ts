...
const productsData: ProductData[] = [
  {
    ...
    stats: new Map<string, string>([
      ...
      ["Camera Lens ", "70 mm"],
      ["Camera  Description", "70 mm"],
      [" Lens Description", "70 mm"],
      ["Camera Lens Desription", "70 mm"],
      ["Came Description", "70 mm"],
      ["Came Decription", "70 mm"],
      ["Came Descrition", "70 mm"],
      ["Came Descripion", "70 mm"],
      ["Cmeescription", "70 mm"],
      ["Cmeescription", "70 mm"],
      ["Cmescripion", "70 mm"],
      ["Cmeecription", "70 mm"],
